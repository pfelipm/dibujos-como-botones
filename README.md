...
This toggle function supports several buttons in the same sheet, adjusting their rows and columns accordingly and calling the assigned Apps Script function for each of them.
